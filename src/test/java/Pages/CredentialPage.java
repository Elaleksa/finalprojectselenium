...
public class CredentialPage extends BasePage{
    ...
    public CredentialPage(ChromeDriver driver) {
        super(driver);
    }
    ...
    public void checkError(){
        ...
        driver.findElement(idPwdError).isDisplayed();
